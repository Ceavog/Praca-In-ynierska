...
namespace Backend.DAL_EF.Migrations
{
    ...
    [Migration("20230410145051_add positions and order again")]
    partial class addpositionsandorderagain
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.DataAccessLibrary.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.DataAccessLibrary.OrderPosition", b =>
                {
                    ...
                    b.HasOne("Backend.DataAccessLibrary.Product", "Product")
                        .WithMany()
